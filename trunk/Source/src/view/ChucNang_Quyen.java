 ...
 * @author vietanh
 */
public class ChucNang_Quyen extends javax.swing.JFrame 
{
...
//                    javax.swing.UIManager.setLookAndFeel(info.getClassName());
        ...
        java.awt.EventQueue.invokeLater(new Runnable() 
        {
            ...
            public void run() 
            {
                ChucNang_Quyen chucNang_Quyen = new ChucNang_Quyen();
                SetCenter setCenter = new SetCenter(chucNang_Quyen);
                chucNang_Quyen.setVisible(true);
                chucNang_Quyen.OnOffEdit(false);
            }
        });
    }
