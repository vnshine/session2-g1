...
public class HangHoa {
	...
	public void setPK_iHangHoaID(Integer pK_iHangHoaID) {
		PK_iHangHoaID = pK_iHangHoaID;
	}
	public String getsTenHangHoa() {
		return sTenHangHoa;
	}
	public void setsTenHangHoa(String sTenHangHoa) {
		this.sTenHangHoa = sTenHangHoa;
	}
	public String getsTenHangHoaEng() {
		return sTenHangHoaEng;
	}
	...
	public void setFK_sDoiTacID(String fK_sDoiTacID) {
		FK_sDoiTacID = fK_sDoiTacID;
	}
	public String getFK_sNhaSanXuatID() {
		return FK_sNhaSanXuatID;
	}
	public void setFK_sNhaSanXuatID(String fK_sNhaSanXuatID) {
		FK_sNhaSanXuatID = fK_sNhaSanXuatID;
	}
	public Integer getFK_iDonViTinhID() {
		return FK_iDonViTinhID;
	}
