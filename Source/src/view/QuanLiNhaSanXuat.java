...
public class QuanLiNhaSanXuat extends JInternalFrame implements ActionListener {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					QuanLiNhaSanXuat frame = new QuanLiNhaSanXuat();
	...
	public QuanLiNhaSanXuat() throws Exception {
		...
		gbl_panel_DuLieu.columnWeights = new double[]{0.0, 0.0, 0.0, 1.0, Double.MIN_VALUE};
		...
		gbc_textField_TenNhomHang.insets = new Insets(0, 0, 5, 5);
		...
		lblTnNhSn = new JLabel("Tên Nhà sản xuất: ");
		GridBagConstraints gbc_lblTnNhSn = new GridBagConstraints();
		gbc_lblTnNhSn.anchor = GridBagConstraints.EAST;
		gbc_lblTnNhSn.insets = new Insets(0, 0, 5, 5);
		gbc_lblTnNhSn.gridx = 2;
		gbc_lblTnNhSn.gridy = 0;
		panel_DuLieu.add(lblTnNhSn, gbc_lblTnNhSn);
		...
		gbc_lblThongBao.insets = new Insets(0, 0, 5, 5);
		...
		gbc_panel_TacVu.insets = new Insets(0, 0, 0, 5);
		gbc_panel_TacVu.gridwidth = 4;
		...
		lblId_2.setAlignmentX(Component.RIGHT_ALIGNMENT);
		mnThm.add(lblId_2);
		
		textField_2 = new JTextField();
		mnThm.add(textField_2);
		...
		lblGhiCh_3 = new JLabel("Ghi chú:");
		lblGhiCh_3.setAlignmentX(1.0f);
		mnThm.add(lblGhiCh_3);
		...
		lblId_3.setAlignmentX(Component.RIGHT_ALIGNMENT);
		menu.add(lblId_3);
		...
		lblGhiCh_4 = new JLabel("Ghi chú:");
		lblGhiCh_4.setAlignmentX(1.0f);
		menu.add(lblGhiCh_4);
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"", "STT", "ID", "T\u00EAn nh\u00E0 s\u1EA3n xu\u1EA5t", "Ghi ch\u00FA", "ID"
			}
		) {
			Class[] columnTypes = new Class[] {
				Boolean.class, Object.class, Object.class, Object.class, Object.class, Integer.class
			};
			public Class getColumnClass(int columnIndex) {
				return columnTypes[columnIndex];
			}
		...
		lblId_1.setAlignmentX(Component.RIGHT_ALIGNMENT);
		mnThm_1.add(lblId_1);
		
		textField = new JTextField();
		mnThm_1.add(textField);
		...
		lblGhiCh_2 = new JLabel("Ghi chú:");
		lblGhiCh_2.setAlignmentX(Component.RIGHT_ALIGNMENT);
		mnThm_1.add(lblGhiCh_2);
		...
		lblId_4.setAlignmentX(Component.RIGHT_ALIGNMENT);
		mnSa.add(lblId_4);
		
		textField_4 = new JTextField();
		mnSa.add(textField_4);
